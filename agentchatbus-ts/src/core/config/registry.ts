...
export const CONFIG_REGISTRY: ReadonlyArray<ConfigDescriptor> = [
  ...
  },
  {
    ...
    description: "Optional override for the Gemini CLI command used by the headless JSON adapter.",
    section: "internal",
    scope: "hidden",
    sensitivity: "runtime",
    restartRequired: true,
  ...
  },
  {
    ...
    description: "Optional override for the Copilot CLI command used by the headless JSON adapter.",
    section: "internal",
    scope: "hidden",
    sensitivity: "runtime",
    restartRequired: true,
  ...
  },
  {
    ...
    persistedKey: "PTY_USE_CONPTY",
    type: "boolean",
    kind: "feature_flag",
    defaultValue: false,
    label: "Use ConPTY for Windows PTY",
    description:
      "Windows interactive CLI sessions use ConPTY when enabled. Disable it if Codex/Cursor/Claude/Gemini/Copilot PTY terminals show rendering glitches, freezes, or cursor drift. Restart required.",
    section: "advanced",
    scope: "editable",
    sensitivity: "runtime",
    restartRequired: true,
    order: 286,
    inputId: "setting-pty-use-conpty",
    resolve: (ctx) => parseBoolLike(
      getRawValue(ctx, { envVar: "AGENTCHATBUS_PTY_USE_CONPTY", persistedKey: "PTY_USE_CONPTY" }, false),
      false
    ),
  },
  {
    key: "LAUNCH_BASE_URL",
    envVar: "AGENTCHATBUS_BASE_URL",
    resolvedField: "launchBaseUrl",
    type: "string",
    kind: "text",
    defaultValue: null,
    label: "Launch Base URL",
    description: "Runtime launch override for the direct MCP base URL injected into CLI sessions.",
    section: "internal",
    scope: "hidden",
    sensitivity: "runtime",
  ...
  },
  {
    ...
    envVar: "AGENTCHATBUS_THREAD_ID",
    resolvedField: "launchThreadId",
    type: "string",
    kind: "text",
    defaultValue: null,
    label: "Launch Thread ID",
    description: "Runtime launch override for the thread id injected into CLI sessions.",
    section: "internal",
    scope: "hidden",
    sensitivity: "runtime",
    restartRequired: false,
    order: 286,
    resolve: () => parseNullableString(getEnvValue("AGENTCHATBUS_THREAD_ID")),
  },
  {
    key: "LAUNCH_THREAD_NAME",
    envVar: "AGENTCHATBUS_THREAD_NAME",
    resolvedField: "launchThreadName",
    type: "string",
    kind: "text",
    defaultValue: null,
    label: "Launch Thread Name",
    description: "Runtime launch override for the thread name injected into CLI sessions.",
    section: "internal",
    scope: "hidden",
    sensitivity: "runtime",
    restartRequired: false,
    order: 287,
    resolve: () => parseNullableString(getEnvValue("AGENTCHATBUS_THREAD_NAME")),
  },
  {
    key: "LAUNCH_AGENT_ID",
    envVar: "AGENTCHATBUS_AGENT_ID",
    resolvedField: "launchAgentId",
    type: "string",
    kind: "text",
    defaultValue: null,
    label: "Launch Agent ID",
    description: "Runtime launch override for the participant agent id injected into CLI sessions.",
    section: "internal",
    scope: "hidden",
    sensitivity: "runtime",
    restartRequired: false,
    order: 288,
    resolve: () => parseNullableString(getEnvValue("AGENTCHATBUS_AGENT_ID")),
  },
  {
    key: "LAUNCH_AGENT_TOKEN",
    envVar: "AGENTCHATBUS_AGENT_TOKEN",
    resolvedField: "launchAgentToken",
    type: "string",
    kind: "secret",
    defaultValue: null,
    label: "Launch Agent Token",
    description: "Runtime launch override for the participant agent token injected into CLI sessions.",
    section: "internal",
    scope: "hidden",
    sensitivity: "secret",
    restartRequired: false,
  ...
  },
  {
    ...
    envVar: "AGENTCHATBUS_AGENT_DISPLAY_NAME",
    resolvedField: "launchAgentDisplayName",
    type: "string",
    kind: "text",
    defaultValue: null,
    label: "Launch Agent Display Name",
    description: "Runtime launch override for the participant display name injected into CLI sessions.",
    section: "internal",
    scope: "hidden",
    sensitivity: "runtime",
    restartRequired: false,
    order: 290,
    resolve: () => parseNullableString(getEnvValue("AGENTCHATBUS_AGENT_DISPLAY_NAME")),
  },
] as const;
