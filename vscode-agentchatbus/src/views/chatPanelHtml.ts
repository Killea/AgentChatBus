import type { WebviewOptions, WebviewPanelOptions } from 'vscode';

export interface ChatPanelResources {
...
export function buildRecoveredChatPanelHtml(): string {
    return `<!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
...
export function buildChatPanelHtml(
    resources: ChatPanelResources,
                ...
                <header id="chat-header">
                    <div id="chat-topbar">
                        ...
                        <div id="topbar-actions">
                            <button id="theme-toggle-btn" class="icon-btn icon-only-btn tooltip-anchor" data-tooltip="Toggle theme" aria-label="Toggle theme">
                                <svg id="theme-icon-sun" class="button-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                ...
                                <svg id="theme-icon-moon" class="button-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:none">
